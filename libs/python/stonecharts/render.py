...
the generated package copy of the shared JS interaction runtime. The canonical
source remains runtime/chart-interactions.js at the repository root and the
release checks require the package asset to match it byte-for-byte.
"""
...
# Generated by tools/generate_runtime_assets.py from the canonical shared runtime.
_RUNTIME_PATH = Path(__file__).resolve().parent / "_assets" / "chart-interactions.js"
