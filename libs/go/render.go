...
// Generated by tools/generate_runtime_assets.py from runtime/chart-interactions.js.
//
//go:embed runtime/chart-interactions.js
var embeddedRuntimeJS string
...
// runtimeJS returns the package-embedded interaction runtime. An explicit
// STONECHARTS_RUNTIME path remains available for controlled development overrides.
func runtimeJS() string {
	...
	if embeddedRuntimeJS != "" {
		return embeddedRuntimeJS
	}
