...
var activeCapabilities = CapabilityManifest{
	...
	ChartTypes:         []string{"area", "arearange", "bar", "boxplot", "bubble", "bullet", "candlestick", "column", "columnrange", "combo", "dumbbell", "error-bar", "funnel", "histogram", "line", "lollipop", "scatter", "timeline", "variwide", "waterfall"},
