...
var activeCapabilities = CapabilityManifest{
	...
	ChartTypes:         []string{"area", "arearange", "bar", "boxplot", "bubble", "bullet", "candlestick", "column", "columnrange", "combo", "dumbbell", "error-bar", "flame-chart", "funnel", "histogram", "line", "lollipop", "scatter", "streamgraph", "technical-indicators", "timeline", "vector-plot", "variwide", "waterfall", "windbarb", "xrange"},
