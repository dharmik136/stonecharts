...
func TestCapabilityManifestAndError(t *testing.T) {
	...
	if got, want := caps.ChartTypes, []string{"area", "arearange", "bar", "bubble", "candlestick", "column", "columnrange", "combo", "error-bar", "histogram", "line", "scatter"}; !reflect.DeepEqual(got, want) {
