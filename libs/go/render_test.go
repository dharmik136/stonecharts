...
func TestCapabilityManifestAndError(t *testing.T) {
	...
	if got, want := caps.ChartTypes, []string{"area", "arearange", "bar", "boxplot", "bubble", "bullet", "candlestick", "column", "columnrange", "combo", "dumbbell", "error-bar", "funnel", "histogram", "line", "lollipop", "scatter", "streamgraph", "timeline", "variwide", "waterfall", "windbarb"}; !reflect.DeepEqual(got, want) {
