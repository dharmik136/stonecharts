...
| S5: Expansion admission | New charts and languages can enter without weakening the core contract | `GATE-S4` passes and release findings are reviewed | Expansion order, conformance kit, compatibility policy, and next release scope approved | Complete (0.0.0.2-0.0.0.4 admitted bar, scatter, bubble; further admission frozen by `DEC-017`) |
