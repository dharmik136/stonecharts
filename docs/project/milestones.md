...
| S1: Contract closure | Active line and column behavior is complete and internally consistent | `GATE-S0` passes | Active scope, stacking, margins, validation, capabilities, customization, and runtime semantics satisfy shared tests | Ready |
