...
SELECT_STYLE = {
    ...
    "Stage": {
        ...
        "S9 Qualification 0.0.0.3": ("GREEN", "Collect conformance and quality evidence for 0.0.0.3"),
        "S10 Release Candidate 0.0.0.3": ("ORANGE", "Build artifacts and immutable evidence for 0.0.0.3"),
        "S11 Release 0.0.0.3": ("PINK", "Authorize and publish 0.0.0.3"),
        "S12 Qualification 0.0.0.4": ("GREEN", "Collect conformance and quality evidence for 0.0.0.4"),
        "S13 Release Candidate 0.0.0.4": ("ORANGE", "Build artifacts and immutable evidence for 0.0.0.4"),
        "S14 Release 0.0.0.4": ("PINK", "Authorize and publish 0.0.0.4"),
    },
    "Target": {
        "0.0.0.1": ("GREEN", "Required for the first governed release"),
        "0.0.0.2": ("BLUE", "Required for the second governed release"),
        "0.0.0.3": ("YELLOW", "Required for the third governed release"),
        "0.0.0.4": ("RED", "Required for the fourth governed release"),
