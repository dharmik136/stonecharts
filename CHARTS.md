...
| `column` | categories[N] + one-or-more series of N numbers | compare a value across categories; grouped, stacked, or percent-stacked composition | trend (use line), x/y correlation (use scatter), part-to-whole (use pie/donut), distributions (use histogram) | Design ✅ · render deferred | [design.md](charts/column/design.md) |
| `bar` | categories[N] + series of numbers | compare categories horizontally (grouped/stacked/percent), ranked; long labels | trend (use line), correlation (use scatter) | Design ✅ · render deferred | [design.md](charts/bar/design.md) |
